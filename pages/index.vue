      ...
      <div class="hero-body">
        <div class="container has-text-centered">
          ...
          <div class="socialicons">
            <a class="has-text-white" target="_blank" rel="noopener" href="//www.linkedin.com/in/patrick-kubica-002027156" aria-label="LinkedIn">
              <font-awesome-icon :icon="['fab', 'linkedin']" class="fa-3x" />
            </a>
            <a class="has-text-white" target="_blank" rel="noopener" href="//xing.com/profile/Patrick_Kubica2" aria-label="Xing">
              <font-awesome-icon :icon="['fab', 'xing']" class="fa-3x" />
            </a>
            <a class="has-text-white" target="_blank" rel="noopener" href="//github.com/PatrickKubica" aria-label="GitHub">
